-- Verificar quantos conflitos existem (aluno ja tem resposta na aula nova)
SELECT 
  COUNT(*) as total_conflitos
FROM respostas_aulas r_old
JOIN respostas_aulas r_new 
  ON r_old.aluno_id = r_new.aluno_id 
  AND r_new.aula_id IN (
    'e50aa7eb-49dc-4a60-8a44-62833cb634b1',
    '9a94f0ee-62ac-4969-b803-a93645775de3',
    '82585e3b-12cd-4a30-9d5a-802891d6d751',
    '2d523cdd-0750-4000-b23b-eed9f5395597',
    'e0f043d7-6cb5-446e-90a5-1515037ac915',
    '4b5c237f-d7ba-47bc-b52f-6cae31d0d6bc',
    'd4a586e6-77c0-4b65-b98a-249a348b663b',
    '02eeda0a-006a-411c-9329-09f823f3c8ac',
    '6e948e2e-e764-4e6e-89a6-4d7eeec487e0',
    '6392d5a1-5700-43d5-9b82-86f2a7cad49e',
    'd8e5a096-c925-4d5f-839f-65c160059ad4',
    'df1d4c28-2c2a-410e-adc2-9254d054053e'
  )
