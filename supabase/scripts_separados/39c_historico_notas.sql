-- Script 39c: Verificar historico_notas para identificar módulos
-- O historico_notas pode ter as informações de curso
...
LEFT JOIN users u ON h.aluno_id = u.id
