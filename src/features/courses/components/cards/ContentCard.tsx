  ...
  return (
    <Link
      ...
      style={{
        ...
        borderTop: `1px solid ${isLocked ? 'var(--glass-border)' : tipoConf.color}33`,
        borderRight: `1px solid ${isLocked ? 'var(--glass-border)' : tipoConf.color}33`,
        borderBottom: `1px solid ${isLocked ? 'var(--glass-border)' : tipoConf.color}33`,
