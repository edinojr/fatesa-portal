...
export type Tab = 'home' | 'users' | 'alumni' | 'content' | 'nucleos' | 'settings' | 'finance' | 'forum' | 'attendance' | 'professors' | 'analytics' | 'reports' | 'docs_archive' | 'academic' | 'grade_history' | 'boletim' | 'avisos' | 'popups' | 'progress' | 'docs_generator';
...
export const useAdminNavigation = () => {
  ...
  const activeTab = useMemo(() => {
    ...
    const validTabs: Tab[] = ['home', 'users', 'alumni', 'content', 'nucleos', 'settings', 'finance', 'forum', 'attendance', 'professors', 'analytics', 'reports', 'docs_archive', 'academic', 'grade_history', 'boletim', 'avisos', 'popups', 'progress', 'docs_generator'];
